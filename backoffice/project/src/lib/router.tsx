...
export type RouteName = 'dashboard' | 'employees' | 'tasks' | 'punches' | 'approvals' | 'projects' | 'exceptions' | 'reports' | 'settings';
...
function parseHash(): Route {
  ...
  const valid: RouteName[] = ['dashboard', 'employees', 'tasks', 'punches', 'approvals', 'projects', 'exceptions', 'reports', 'settings'];
